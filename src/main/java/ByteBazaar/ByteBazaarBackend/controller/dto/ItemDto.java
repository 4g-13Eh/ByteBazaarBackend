...
public class ItemDto {
    @NotBlank(message = "One of the follwing properties is null: itemId, name, description, picture. Can't be null")
    private String itemId, name, description, picture;
    @DecimalMin(value = "0.01", message = "Price must be atleat 0.01")
    @Digits(fraction = 2, message = "Price can't have more than 6 integral digits & 2 fractional digits", integer = 6)
    private Float price;
    private Boolean in_stock;
    @PositiveOrZero(message = "Stock_num must be atleast 0")
